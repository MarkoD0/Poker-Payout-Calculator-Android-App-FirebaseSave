...
class CashoutActivity : AppCompatActivity() {
    ...
    // cashout dugme (remains the same)
    ...
    private fun handleConfirmCashout() {
        ...
        currentPlayer?.let { player ->
            ...
            showConfirmationDialog("Confirm Cashout?", "Are you sure you want to confirm this cashout of $cashoutAmount?", {
                player.isPlaying = false // Player is no longer playing
                ...
                if (isFromLoansSelected) {
                    ...
                    if (netDifference < 0) {
                        ...
                        player.balance = 0
                        currentHouseBalance -= netDifference // Update house balance locally
                        finalMessage = String.format(
                            Locale.US,
                ...
                // --- REMOVED: saveAllPlayerDataFromCashoutActivity() ---
                Toast.makeText(this, "Cashout processed. Data will be saved on return.", Toast.LENGTH_SHORT).show()
    ...
    // konfirm dijalog (remains the same)
