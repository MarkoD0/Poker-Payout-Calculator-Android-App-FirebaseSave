...
const val RESULT_CODE_NEW_GAME = 101 // Custom result code for starting a new game
const val RESULT_EXTRA_GAME_ENDED_DATA = "com.example.pokerpayoutcalc.GAME_ENDED_DATA" // For passing back GameData
...
// Add new constants for results (assuming they are in your constants file or defined here for clarity)
// const val RESULT_CODE_NEW_GAME = 101 // Custom result code for starting a new game
// const val RESULT_EXTRA_GAME_ENDED_DATA = "com.example.pokerpayoutcalc.GAME_ENDED_DATA" // For passing back GameData
...
class EndGameActivity : AppCompatActivity() {
    ...
    override fun onBackPressed() {
        // Return the final game data to MainActivity
        val gameData = GameData(
            players = mutableAllPlayers,
            houseBalance = mutableHouseBalance,
            isGameEnded = true // Mark game as ended when returning from this activity
        )
        val resultIntent = Intent().apply {
            putExtra(RESULT_EXTRA_GAME_ENDED_DATA, gameData)
        }
    ...
    // --- REMOVED: saveCurrentGameState() function ---
    /*
    ...
    private fun showStartNewGameConfirmationDialog() {
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("YES") { dialog, _ ->
                // Signal MainActivity to clear data and start a new game
                setResult(RESULT_CODE_NEW_GAME) // Use your custom result code
                Toast.makeText(this, "Signaling new game. Data will be cleared by main activity.", Toast.LENGTH_LONG).show()

                // No need to explicitly start MainActivity here, just finish this one.
                // MainActivity will handle the intent to restart itself.
                finish()
                dialog.dismiss()
            }
